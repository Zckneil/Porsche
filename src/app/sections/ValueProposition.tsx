...
const valuePoints = [
  ...
  },
  {
    ...
    description: "Complete with Certificate of Authenticity from Porsche, service records, and ownership history.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Recently serviced by Porsche specialists with meticulous attention to detail, ensuring reliable performance.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
